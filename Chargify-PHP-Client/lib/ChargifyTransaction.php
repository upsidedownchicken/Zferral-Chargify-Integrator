...
class ChargifyTransaction extends ChargifyBase
{
	...
	private $connector;
	public function __construct(SimpleXMLElement $product_xml_node = null, $test_mode = false, $domain = null, $key = null)
	{
		$this->connector = new ChargifyConnector($test_mode, $domain, $key);
		if ($product_xml_node) {
